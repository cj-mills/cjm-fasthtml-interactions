...
The `LoadingType` enum defines the types of loading indicators
available.
...
The `AsyncLoadingContainer` function creates a container that displays a
loading indicator and asynchronously loads content from a URL using
HTMX.
